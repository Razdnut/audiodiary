...
const translations: Translations = {
  it: {
    ...
    'daily.deleteNote.confirm': 'Eliminare definitivamente questa nota? L\'eventuale audio sarÃ  rimosso.',
    'daily.noteN': 'Nota {n}',
    ...
    'settings.description': 'Configura la tua chiave API di OpenAI e i modelli da utilizzare. La tua chiave API Ã¨ salvata solo nel tuo browser.',
    ...
    'settings.deleteAllAudio.confirm': 'Sei sicuro di voler eliminare TUTTI i file audio, trascrizioni e sintesi salvate? Questa azione non puÃ² essere annullata.',
